...
${symbol_dollar}(function(){
	_assignUserTab=${symbol_dollar}('${symbol_pound}assignRoleTab').tabs({
			//width:1020,
			//height:430
		});
});
...
<div id="assignRoleTab" style="padding:5px;">
    <div title="<s:text name='label.pm.common.selected'></s:text>"  closable="false" style="overflow:hidden;padding:5px;" cache="false" href="${symbol_dollar}{ctx}/pm/user/user!forSelectedRole.action?userId=${symbol_dollar}{userId}">
<!--	<iframe src="${symbol_dollar}{ctx}/pm/group/group!forUnselectedUser.action?groupId=${symbol_dollar}{groupId}" frameborder="0" width="900" height="300" marginheight="0" marginwidth="0" scrolling="no"></iframe>-->
    ...
    <div title="<s:text name='label.pm.common.unselected'></s:text>"  closable="false" style="overflow:hidden;padding:5px;" cache="false" href="${symbol_dollar}{ctx}/pm/user/user!forUnselectedRole.action?userId=${symbol_dollar}{userId}">
