...
<div id="assignPrivilege">
    <div title="${symbol_dollar}{name}--<s:text name='label.pm.common.privilege.functionality'></s:text>"  selected="true" style="overflow:hidden;padding:5px;" href="${symbol_dollar}{ctx}/pm/role/role!forAssignFunc.action?roleId=${symbol_dollar}{roleId}">
<!--		<iframe src="${symbol_dollar}{ctx}/pm/module/module!forAssignUser.action?moduleId=${symbol_dollar}{moduleId}" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no"></iframe>-->
    ...
    <div title="${symbol_dollar}{name}--<s:text name='label.pm.common.privilege.data'></s:text>"  style="overflow:hidden;padding:5px;" href="${symbol_dollar}{ctx}/pm/role/role!forAssignData.action?roleId=${symbol_dollar}{roleId}">
