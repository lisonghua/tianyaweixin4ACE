...
jq(function(){
	...
	_input_params_list=jq('${symbol_pound}input-params-list').datagrid({
		//title:"Listener",
	    ...
	    toolbar:[{
	        ...
	        handler:function(){
				...
				jq('${symbol_pound}input-params-list').datagrid('appendRow',{
					id:'',
					_source:'',
					sourceExpression:'',
					_target:'',
				...
				var index = jq('${symbol_pound}input-params-list').datagrid('getRows').length-1;
				jq('${symbol_pound}input-params-list').datagrid('beginEdit', index);
	        }
	    }],
	...
	_output_params_list=jq('${symbol_pound}output-params-list').datagrid({
		//title:"Listener",
		//url:'${symbol_dollar}{ctx}/wf/procdef/procdef!search.action',//加载表格数据的URL
		singleSelect:true,
		//width:500,
	    ...
	    toolbar:[{
	        ...
	        handler:function(){
				...
				jq('${symbol_pound}output-params-list').datagrid('appendRow',{
					id:'',
					_source:'',
					sourceExpression:'',
					_target:'',
				...
				var index = jq('${symbol_pound}output-params-list').datagrid('getRows').length-1;
				jq('${symbol_pound}output-params-list').datagrid('beginEdit', index);
	        }
	    }],
...
function saveTaskMainConfig(){
	task.callElement=jq('${symbol_pound}callElement').val();
...
function loadTaskMainConfig(){
	jq('${symbol_pound}callElement').val(task.callElement);
	loadInputParams();
	loadOutputParams();
}
