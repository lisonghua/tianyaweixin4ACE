...
<!--
jq(function(){
	_task_candidate_unselected_group_panel_obj=jq('${symbol_pound}_task_candidate_unselected_group_panel').panel({
		//height:600,
		border:false,
		noheader:true,
		top:0,
	...
	_task_candidate_unselected_group_grid=jq('${symbol_pound}_task_candidate_unselected_group_table').datagrid({
		title:"<s:text name='label.pm.group.list'></s:text>",
		url:'${symbol_dollar}{ctx}/wf/procdef/procdef!searchCandidateGroup.action',
		//singleSelect:true,
		idField:'groupId',
		height:400,
		pagination:true,
...
<div>
	<table border="0">
		<tr>
			...
			<td><a href="${symbol_pound}" class="easyui-linkbutton" iconCls="icon-search" onclick="searchTaskCandidateUnselectedGroup();"><s:text name='button.common.search'></s:text></a></td>
		</tr>
	</table>
</div>
<div>
