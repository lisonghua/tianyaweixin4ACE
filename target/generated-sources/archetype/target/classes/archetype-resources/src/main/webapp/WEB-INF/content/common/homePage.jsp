...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${symbol_dollar}{ctx}/js/jquery-easyui/extend/portal/portal.css">
	<script type="text/javascript" src="${symbol_dollar}{ctx}/js/jquery-easyui/extend/portal/jquery.portal.js"></script>
</head>
<script>
		${symbol_dollar}(function(){
			${symbol_dollar}('${symbol_pound}pp').portal({
				border:false,
				fit:true
				//height:600,
				//width:'auto'
			});
			${symbol_dollar}('${symbol_pound}myCalender').calendar({   
			    fit:true,  
			    current:new Date()   
			});
			_my_message_list_grid=${symbol_dollar}('${symbol_pound}_my_message_list').datagrid({
...
<body class="easyui-layout">
	<div region="center" split="true" border="false">
		...
		<div id="pp" style="position:relative">
			<div style="width:30%">
				<div id="panel1" title="Calendar" style="width:100%;height:180px;padding:0px;background:${symbol_pound}fafafa;"  
				        iconCls="portlet-calendar-icon"  closable="true"  
				        collapsible="true" minimizable="false" maximizable=false>  
					<div id="myCalender"></div> 
				</div>
				<div id="panel2" title="Clock" style="text-align:center;background:${symbol_pound}ECF9F9;width:auto;height:250px;padding:0px"  
				...
				<div id="myWeather" title="Weather" style="width:auto;height:250px;padding:0px;background:${symbol_pound}fafafa;"  
...
<!--						<iframe src="http://m.weather.com.cn/m/pn12/weather.htm " width="100%" height="100%" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no"></iframe>-->
			...
			<div style="width:70%">
				<div id="myTask" title="My Task" style="width:auto;height:300px;padding:0px;background:${symbol_pound}fafafa;"  
				        iconCls="portlet-task-icon"  closable="true"  
				        collapsible="true" minimizable="false" maximizable=false>
					<%@ include file="portlet/myTask.jsp" %>
				</div>
			    <div id="myMessage" title="My Massage" style="width:auto;height:300px;padding:0px;background:${symbol_pound}fafafa;"  
