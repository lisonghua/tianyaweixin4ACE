...
${symbol_dollar}(function(){
	_edit_grid_panel_obj=${symbol_dollar}('${symbol_pound}_edit_grid_panel').panel({
		//height:370
		fit:true
	});
	_qstring_edit_grid_obj=${symbol_dollar}('${symbol_pound}_qstring_edit_grid').datagrid({
			...
			toolbar:[{
					...
					handler:function(){
						...
						${symbol_dollar}('${symbol_pound}_qstring_edit_grid').datagrid('appendRow',{
							param:'',
							operator:'',
							value:''
						});
						var index = ${symbol_dollar}('${symbol_pound}_qstring_edit_grid').datagrid('getRows').length-1;
						${symbol_dollar}('${symbol_pound}_qstring_edit_grid').datagrid('beginEdit', index);
						//alert(editcount);
					}
				},'-',{
				id : 'btnsave',   
...
function confirmConditions(){
	...
	/*
    ${symbol_dollar}.ajax({
			url:"${symbol_dollar}{ctx}/sm/appserver/appserver!exportEverydayAccessNum4PerAppReport.action",
		type: 'POST',
		data:{
