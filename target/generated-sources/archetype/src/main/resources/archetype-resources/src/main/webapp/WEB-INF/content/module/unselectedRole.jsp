...
${symbol_dollar}(function(){
	//_unselected_role_panel_obj=${symbol_dollar}('${symbol_pound}_unselected_role_panel').panel({
		//fit:true
	//});
	_unselected_roles_grid=${symbol_dollar}('${symbol_pound}unselectedRoleTable').datagrid({
		title:"<s:text name='label.pm.role.list'></s:text>",
		url:'${symbol_dollar}{ctx}/pm/module/module!searchUnselectedRole.action?moduleId=${symbol_dollar}{moduleId}',
		//singleSelect:true,
		//width:900,
		height:380,
		idField:'roleId',
	...
	_unselected_role_form_obj=${symbol_dollar}('${symbol_pound}unselectedRoleForm');
});
function addRoles(){
	...
	_unselected_role_form_obj.form('submit',{
		url:'${symbol_dollar}{ctx}/pm/module/module!addRoles.action',
