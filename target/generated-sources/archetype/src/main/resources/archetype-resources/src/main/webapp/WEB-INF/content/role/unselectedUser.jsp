...
${symbol_dollar}(function(){
	...
	_role_unselected_users_grid=${symbol_dollar}('${symbol_pound}roleUnselectedUserTable').datagrid({
		...
		url:'${symbol_dollar}{ctx}/pm/role/role!searchUnselectedUser.action?roleId=${symbol_dollar}{roleId}',
		//singleSelect:true,
		//width:900,
		height:390,
		idField:'userId',
	...
	_role_search_group=${symbol_dollar}('${symbol_pound}_role_search_unslt_groupId').combobox({
...
function addUsers(){
	...
	_role_unselected_user_form_obj.form('submit',{
		url:'${symbol_dollar}{ctx}/pm/role/role!addUsers.action',
